...
import PublicServiceList from "./ServiceList";
  ...
  return (
    <div style={styles.wrapper}>
      ...
      <div style={styles.contentContainer}>
        <h1 style={styles.sectionTitle}>Luxury Services & Amenities</h1>
        <p style={styles.sectionSubtitle}>
          Discover premium services designed to enhance your lifestyle. From personal wellness to 
          exclusive concierge solutions, find the perfect service for your needs.
        </p>
        
        <div style={styles.serviceListWrapper}>
          <PublicServiceList />
        </div>
      </div>
