    ...
    <div style={styles.wrapper}>
      ...
      <div style={styles.contentContainer}>
        ...
        <main style={styles.mainContent}>
          ...
          <h1 className="title" style={styles.title}>Reset Password</h1>
          ...
          <div className="form-container" style={styles.formContainer}>
            ...
            {loading ? (
              ...
              <div style={styles.errorMessage}>
                <Text size="lg" weight={600} mb={10}>Invalid Reset Link</Text>
                <Text size="md">
                ...
                <Button
                  ...
                  style={{ marginTop: '1.5rem', ...styles.resetButton }}
                >
                  Request New Link
                </Button>
              </div>
              ...
              <div style={styles.successMessage}>
                <Text size="lg" weight={600} mb={10}>Password Reset Successful!</Text>
                <Text size="md">
