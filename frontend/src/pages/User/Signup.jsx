    ...
    <div style={styles.wrapper}>
      ...
      <div style={styles.contentContainer}>
        ...
        <main style={styles.mainContent}>
          ...
          <div className="subtitle" style={styles.linkText}>
          ...
          <div className="form-container" style={styles.formContainer}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <TextInput
                label="Name"
                placeholder="Kaveesha Chathurindi"
                required
                withAsterisk={false}
                value={name}
              ...
              {/* IsOwner Checkbox */}
              <Group justify="space-between" mt="lg" style={{marginBottom: '1rem', position: 'relative', zIndex: 1}}>
                <Checkbox
