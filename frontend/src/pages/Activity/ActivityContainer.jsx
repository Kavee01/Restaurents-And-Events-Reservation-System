...
import PublicActivityList from "./ActivityList";
  ...
  return (
    <div style={styles.wrapper}>
      ...
      <div style={styles.contentContainer}>
        <h1 style={styles.sectionTitle}>Premium Activities & Adventures</h1>
        <p style={styles.sectionSubtitle}>
          Discover extraordinary leisure activities that create lasting memories. From thrilling adventures to 
          relaxing experiences, find the perfect activity to enhance your journey.
        </p>
        
        <div style={styles.activityListWrapper}>
          <PublicActivityList />
        </div>
      </div>
