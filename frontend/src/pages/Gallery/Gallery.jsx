...
function Gallery() {
  ...
  const images = [
    { id: 1, src: '/bg1.jpg', title: 'Luxury Dining Experience' },
    { id: 2, src: '/bg2.jpg', title: 'Elegant Events' },
    { id: 3, src: '/bg3.jpg', title: 'Fine Dining' },
    { id: 4, src: '/bg4.jpg', title: 'Special Occasions' },
    { id: 5, src: '/bg5.jpg', title: 'Exclusive Gatherings' },
    { id: 6, src: '/bg6.jpg', title: 'Premium Service' },
    { id: 7, src: '/bg7.jpg', title: 'Memorable Moments' },
  ];
      ...
      <div style={styles.contentContainer}>
        ...
        <div style={styles.heroSection}>
          ...
          <p style={styles.subtitle}>
            Explore our collection of memorable moments, exquisite dining experiences, and elegant events that define luxury at PearlReserve.
          </p>
        </div>
              ...
              >
                ...
                <div className="overlay" style={styles.galleryOverlay}>
                  <div style={{ textAlign: 'center' }}>
                    <IconZoomIn size={40} color="white" style={{ marginBottom: '0.5rem' }} />
                    <Text color="white" weight={600}>{image.title}</Text>
                  </div>
                </div>
              </div>
            ))}
