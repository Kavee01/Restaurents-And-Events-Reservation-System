    ...
    <div style={styles.wrapper}>
      ...
      <div style={styles.contentContainer}>
        ...
        <div style={styles.heroSection}>
          <h1 style={styles.mainTitle}>Discover Exceptional Experiences</h1>
          <p style={styles.subtitle}>
            Explore the finest dining, exclusive events, premium activities, and luxury services—all in one place.
            Your journey to remarkable experiences begins with PearlReserve.
          </p>
          <div style={{
            display: 'flex',
            gap: '1rem',
            ...
            <Link 
              ...
              onMouseOut={(e) => {
                e.target.style.transform = 'translateY(0)';
                e.target.style.boxShadow = '0 4px 10px rgba(209, 174, 54, 0.3)';arget.style.backgroundColor = 'rgba(209, 174, 54, 0.85)';
              }}
            >
              Discover Events
            </Link>
