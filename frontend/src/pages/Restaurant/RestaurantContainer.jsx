  ...
  return (
    <div style={styles.wrapper}>
      ...
      <div style={styles.contentContainer}>
        <h1 style={styles.sectionTitle}>Exceptional Dining Experiences</h1>
        <p style={styles.sectionSubtitle}>
          Discover the finest restaurants offering unforgettable culinary journeys. From intimate bistros to award-winning establishments, find your perfect dining destination.
        </p>
        
        <div style={styles.restaurantListWrapper}>
          <RestaurantList />
        </div>
      </div>
